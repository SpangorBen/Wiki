				...
				<nav class="mt-0 w-full">
					<div class="container mx-auto flex items-center">
						...
						<div class="flex w-1/2 justify-end content-center">
							<?php if($_SESSION['user'] == 'author'){?>
								<a href="../pages/logout" class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-3 px-2">Logout</a>
							<?php }else{?>
								<a href="../pages/login" class="inline-block text-gray-600 no-underline hover:text-gray-200 hover:underline py-3 px-2">Login</a>
							<?php }?>								
